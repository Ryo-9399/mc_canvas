		...
		if (this.co_j.vx == 0 && this.co_j.vy == 0) {
			...
			if (this.mp.tr1_c == 1) {
				if (this.checkStage() >= 1) {
					...
					// メッセージの人１
					this.km.init1(4);
					this.km.onKao(4, rounddown((this.gg.di.width - 272) / 2), rounddown(this.gg.di.height / 2) - 108, 272, 230);
					this.km.init1(3);
					this.km.setMessage(3, this.mp.mes1_name);
					...
					// メッセージの人２
					this.km.init1(4);
					this.km.onKao(4, rounddown((this.gg.di.width - 272) / 2), rounddown(this.gg.di.height / 2) - 108, 272, 232);
					this.km.init1(3);
					this.km.setMessage(3, this.mp.mes2_name);
					...
					// 店
					this.km.init1(4);
					this.km.onKao(4, rounddown((this.gg.di.width - 272) / 2), rounddown(this.gg.di.height / 2) - 108, 216, 234);
					...
					// 説明する人
					this.km.init1(4);
					this.km.onKao(4, rounddown((this.gg.di.width - 272) / 2), rounddown(this.gg.di.height / 2) - 108, 272, 236);
					this.km.init1(3);
					this.km.setMessage(3, this.mp.setumei_name);
