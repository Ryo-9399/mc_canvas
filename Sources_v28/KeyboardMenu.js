...
KeyboardMenu.prototype.activeJibun = function(
	paramInt1,
	paramInt2,
	paramInt3,
	paramInt4,
	...
	for (var i = 0; i <= 15; i++) {
		...
		switch (c) {
			...
			case 420:
				...
				this.gg.drawPT(
					this.x[i] + 12 + ((this.width[i] - 24 - 32) >> 1),
					this.y[i] + 12 + 8,
					this.item_int[i][2],
					0
				);
